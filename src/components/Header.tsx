...
export const Header = ({ language, onLanguageToggle, onNavigate, theme, onThemeToggle }: HeaderProps) => {
  ...
  return (
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-slate-900 to-gray-900 text-white dark:bg-transparent glass-effect border-none !border-0 shadow-none">
